    ...
    slides: [
      {
        images: [
          {
            title: 'CIMICO Steering Committee with the Nigerian Minister of Defence His Excellency Mohammed Badaru. ',
            path: '/CIMICO Steering Committee with the Nigerian Minister of Defence His Excellency Mohammed Badaru.jpg',
          },
          {
          ...
          {
            title: 'CIMICO Steering Committee with the Nigerian Chief of Defence staff Gen. Christopher Musa. ',
            path: '/CIMICO Steering Committee with the Nigerian Chief of Defence staff Gen. Christopher Musa.jpg',
          },
          {
            ...
            {slide.images.map((image, index)=> {
              ...
              items-center justify-center group' key={index}>
                ...
                overflow-hidden group'> 
                  ...
                  group-hover:-translate-y-10 group-hover:xl:-translate-y-5
                  transition-all duration-300'>
                    {image.title}
                    <div className='flex items-center gap-x-2 text-[3px] tracking-[0.2em]'>
                      {/* title part 1 */}
                      {/* title part 2 */}
